        ...
        <section className="max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          <div className="mt-24 max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {/* LinkedIn */}
              <div className="bg-white p-8 rounded-3xl shadow-xl border-4 border-blue-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center">
          ...
          42.6-48.3 87.7-48.3 93.8 0 111.1 61.8 111.1 142.3V448z"
              ...
              {/* GitHub */}
              <div className="bg-white p-8 rounded-3xl shadow-xl border-4 border-gray-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center">
          ...
          8.013 0 0016 8c0-4.42-3.58-8-8-8z"
              ...
              {/* ChatGPT */}
              <div className="bg-white p-8 rounded-3xl shadow-xl border-4 border-green-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center">
          ...
          <div className="mt-24 max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              {/* Udemy */}
              <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-purple-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center h-52 justify-center">
              ...
              {/* Coursera */}
              <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-blue-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center h-52 justify-center">
              ...
              {/* Google Classroom */}
              <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-green-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center h-52 justify-center">
              ...
              <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-grey-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center h-52 justify-center">
