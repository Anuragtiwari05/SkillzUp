  ...
  return (
    <div className="min-h-screen bg-blue-50 font-sans">
      ...
      <main className="flex flex-col items-center justify-center mt-16 px-4 text-center">
        ...
        <p className="text-black mb-8 max-w-2xl text-lg md:text-xl animate-fadeIn delay-200">
        ...
        >
          <input
            ...
            className="flex-1 px-6 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg rounded-l-lg text-black"
            value={query}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
          <div className="bg-white shadow-lg rounded-lg p-6 hover:scale-105 hover:shadow-2xl transition-transform duration-300">
            <h3 className="text-xl font-bold mb-2 text-blue-700">Curated Roadmaps</h3>
            <p className="text-black">Step-by-step guides to learn any technology efficiently.</p>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-6 hover:scale-105 hover:shadow-2xl transition-transform duration-300">
            <h3 className="text-xl font-bold mb-2 text-blue-700">Video Tutorials</h3>
            <p className="text-black">Learn by watching practical examples from top creators and educators.</p>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-6 hover:scale-105 hover:shadow-2xl transition-transform duration-300">
            <h3 className="text-xl font-bold mb-2 text-blue-700">Articles & News</h3>
            <p className="text-black">Stay updated with the latest articles, guides, and news in tech.</p>
          </div>
        </div>

        {/* Call-to-Action */}
        <div className="mt-24 bg-blue-100 rounded-xl shadow-inner p-10 max-w-5xl hover:scale-102 transition-transform duration-300">
